...
<p align="center"><i>A video representing the detection of centers of mass and tracing of center-of-mass trajectories over time</i>.</p>
</div>
...
- [Step 02: Voltage to current flow conversion (sinks and sources). Detection of centers of mass and tracing of center-of-mass trajectories.](https://github.com/LBitn/Hippocampus-HDMEA-CSDA/blob/main/STEP02_v1.ipynb)

- [ACD: Detection of channels corresponding to viable tissue. Separation of channels providing physiological signals from noise.](https://github.com/LBitn/Hippocampus-HDMEA-CSDA/blob/main/ACD.ipynb)
...
- [Angel Vazquez Flores](https://github.com/Angeldk16): Parameter optimization, testing
- [Francisco Victorio Santiago](https://github.com/IMFrankVS): Testing and suggestions
- [Isabel Romero Maldonado](https://github.com/LBitn): Code and data analysis
- [Jorge Antonio Hernández García](https://github.com/JorgeGarciaAH): Testing and suggestions
- [Karel Zapfe Aguilar](https://github.com/kzapfe): Author of the concept and source code
- [Luis Reynaldo Ramos González](https://github.com/LuigiRA): Testing and optimization
